...
{
    _expect_check(function, parameter, file, line, check_value, (CMockaValueData) {
        .uint_val = value
    }, NULL,
    count);
}
...
{
    _expect_check(function, parameter, file, line, check_any, (CMockaValueData) {
        .ptr = NULL
    }, NULL,
    count);
}
